# rag.py
# Stage 2: Knowledge Base RAG Engine using Custom TF-IDF and Groq LLM
...
def get_client():
    ...
    if _client is None:
        _client = OpenAI(
            ...
            api_key=os.environ.get("GROQ_API_KEY", "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"),
        )
    return _client
...
class CustomGroqRAG:
    def __init__(self):
        ...
        print(f"[Info] Custom TF-IDF Knowledge Index loaded with {num} chunks.")

    def query_guidelines(self, question: str) -> str:
...
# Singleton instance matching main.py's expected import
rag_engine = CustomGroqRAG()
